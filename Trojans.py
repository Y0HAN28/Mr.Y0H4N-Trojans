...
def usage():
	print (''' \033[92m  	 SILAHKAN ANDA BOM 

    <<------------------------------------------------------>>
        Author: MR.Y0H4N"
        WhatsApp : 087741662524 "
        Thanks for Termux
    <<------------------------------------------------------->>
...
----------------
    ...
    pakai lah dengan bijak,saya tak bertanggung jawab atas down nya
    suatu server!
    

  Contoh: python3 Trojans.py -s (ip Yang Mau Lu Serang) -p (isi aja 80) -t (turbo 135) 
